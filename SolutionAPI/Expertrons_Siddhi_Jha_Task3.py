...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
	<soapenv:Header>
		<com:AUFHeaderRespo nse xmlns:com="http://schemas.auf.com/integration/common">
	...
	<soapenv:Body>
		<ns2:GetCustomer360DetailsResponse xmlns:ns2="http://schemas.auf.com/integration/customer">
			<ns2:TransactionStatus>
				<com:ResponseCode xmlns:com="http://schemas.auf.com/integration/common">0
				</com:ResponseCode>
				<com:ResponseMessage xmlns:com="http://schemas.auf.com/integration/common">Success
				</com:ResponseMessage>
				<com:ExtendedErrorDetails xmlns:com="http://schemas.auf.com/integration/common">
					<com:messages>
						<com:code>0</com:code>
					</com:messages>
			...
			<ns2:CustomerResponse>
				<ns2:CustomerBasicInquiry>
					<com:CustomerId xmlns:com="http://schemas.auf.com/integration/common">24047514213
					</com:CustomerId>
					<com:NationalIdentificationCode xmlns:com="http://schemas.auf.com/integration/common">8751
					</com:NationalIdentificationCode>
					...
					<com:CustomerFullName xmlns:com="http://schemas.auf.com/integration/common">SUMAN KU
					</com:CustomerFullName>
					<com:OfficerID xmlns:com="http://schemas.auf.com/integration/common">First teller</com:OfficerID><com:CustomerAddress xmlns:com="http://schemas.auf.com/integration/common">
					...
					<com:Home Branch xmlns:com="http://schemas.auf.com/integration/common">2143</com:HomeBranch>
					...
					<com:CustomerTyp e xmlns:com="http://schemas.auf.com/integration/common">100</com:CustomerType>
				</ns2:CustomerBasicInquiry>
			</ns2:CustomerResponse>
			<ns2:AccountDetails>
				<com:CustomerAccount xmlns:com="http://schemas.auf.com/integration/common">
					<com:ModuleCode>C</com:ModuleCode>
					...
					<com:FutureDatedAm ount>0.00</com:FutureDatedAmount>
					<com:SafeDepositBoxId>0</com:SafeDepositBoxId>
					<com:DateAcc ountOpen>2019-06-25</com:DateAccountOpen>
				...
				<com:IsCustomerSchemeAvailable xmlns:com="http://schemas.auf.com/integration/common">false
...
#Extract number from xml data
number = soup.find('com:MobileNumber')

##Getting content from request
http = urllib3.PoolManager()
contents = http.request('GET', 'https://api.datayuge.com/v1/lookup/'+ number.text)
print(contents.data)